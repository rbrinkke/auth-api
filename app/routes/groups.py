...
@router.get(
    ...
    summary="List Groups",
    description="List all groups in organization (requires membership)"
)
async def list_organization_groups(
    ...
    **Returns**: List of groups with member counts
    """
    service = GroupService(db)
    return await service.get_organization_groups(org_id, current_user_id)
...
@router.get(
    ...
    response_model=GroupResponse,
    summary="Get Group",
    description="Get group details (requires membership in group's organization)"
)
async def get_group(
    group_id: UUID,
    current_user_id: UUID = Depends(get_current_user_id),
    ...
    **Returns**: Group details
    """
    service = GroupService(db)
    return await service.get_group(group_id, current_user_id)
